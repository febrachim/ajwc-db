...
const storage = multer.diskStorage({
  destination: (req, file, cb) => {
    if(req.url === '/companiesupload') {
      cb(null, config.filePathCompany)
    } else if (req.url === "/hiringsupload") {
      cb(null, config.filePathHiring)
    } else if (req.url === "/dealsupload") {
      cb(null, config.filePathDeals)
    } else if (req.url === "/peoplesupload") {
      cb(null, config.filePathPeople)
    } else {
